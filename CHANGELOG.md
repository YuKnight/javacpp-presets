 ...
 * Rename `groupId` to "org.bytedeco" and use ModiTect to modularize all presets to comply with JPMS ([pull #681](https://github.com/bytedeco/javacpp-presets/pull/681))
